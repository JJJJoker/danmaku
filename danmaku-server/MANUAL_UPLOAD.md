...
- SSH access to your server (116.62.47.225)
...
- Try: `ssh -v root@116.62.47.225` for verbose output
...
- Consider using rsync for incremental updates:
  ...
  rsync -avz --exclude 'node_modules' --exclude 'dist' \
    ./danmaku-server/ root@116.62.47.225:/opt/danmaku-server/
  ```
...
1. **Test Remote Connection**:
   - Modify client `SERVER_URL` to `ws://116.62.47.225:8080`
